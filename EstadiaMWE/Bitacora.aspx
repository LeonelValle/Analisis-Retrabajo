    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="left">
                    <div style="text-align: left; margin: 1px">
                        ...
                        <asp:Label Style="font-family: Calibri; position: absolute; top: 10px; left: 47%;" runat="server" Text="Bitacora" Font-Size="XX-Large" Font-Bold="true"></asp:Label>
                        <br />
            ...
            <asp:Label ID="Label5" runat="server" Text="Fecha "></asp:Label>
                    &nbsp;&nbsp;
        <asp:TextBox ID="txtFecha" runat="server" AutoCompleteType="Disabled" CssClass="css-input" TextMode="Date" onkeypress="return false;" onpaste="return false" Width="125px" OnTextChanged="txtFecha_TextChanged"></asp:TextBox>
