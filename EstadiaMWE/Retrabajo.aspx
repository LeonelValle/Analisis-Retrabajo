    ...
    <form id="form2" runat="server">
        ...
        <div class="left">
            <div style="text-align: left; margin: 8px">
                ...
                <asp:Label Style="font-family: Calibri; position: absolute; top: 10px; left: 43%;" runat="server" Text="Retrabajo" Font-Size="XX-Large" Font-Bold="true"></asp:Label>
                <br />
            ...
            <asp:UpdatePanel ID="PanelInfoUnidad" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    &nbsp;&nbsp;
                    <asp:Button ID="btnNuevo" CssClass="greenButton" runat="server" Height="42px" Text="Retrabajo rapido" Width="185px" OnClick="btnNuevo_Click" />
             ...
             <ajaxToolkit:ComboBox ID="ddlStatus" runat="server" AutoPostBack="True" DropDownStyle="DropDownList"
                 AutoCompleteMode="Append">
                        ...
                        <br />
                        <br />
                        <asp:Label ID="lblObligatorio1" runat="server" CssClass="labelStyle" ForeColor="Red" Text="*"></asp:Label>
      ...
      <ajaxToolkit:ComboBox ID="ddlPartNumber" runat="server" AutoPostBack="True" DropDownStyle="DropDownList"
          AutoCompleteMode="Append">
                        ...
                        <br />
                        <br />
                        <asp:Label ID="lblObligatorio2" runat="server" CssClass="labelStyle" ForeColor="Red" Text="*"></asp:Label>
        ...
        <asp:TextBox ID="txtFalla" Style="resize: none;" AutoCompleteType="Disabled" CssClass="css-input" runat="server" Height="35px" TextMode="MultiLine" Width="197px" MaxLength="30"></asp:TextBox>
                        <br />
                        <br />
                        <asp:Label ID="lblObligatorio3" runat="server" CssClass="labelStyle" ForeColor="Red" Text="*"></asp:Label>
        ...
        <ajaxToolkit:ComboBox ID="ddlArea" runat="server" AutoPostBack="True" DropDownStyle="DropDownList"
            AutoCompleteMode="Append">
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="btnCalidad" EventName="Click" />
                    <asp:AsyncPostBackTrigger ControlID="btnScrap" EventName="Click" />
            ...
            <%-- Segundo Panel --%>
            <asp:UpdatePanel ID="PanelDefectos" runat="server" UpdateMode="Conditional">
                ...
                <ContentTemplate>
                    <fieldset>
                        ...
                        <br />
                        <br />
                        <asp:GridView ID="gvDefectos" runat="server" Style="font-family: Calibri" OnRowCreated="gvDefectos_RowCreated">
                        </asp:GridView>
                        <br />
                        <asp:Label runat="server" CssClass="labelStyle" Text="*" ID="lblObligatorio5" ForeColor="Red" />
                        <asp:Label ID="Label16" runat="server" CssClass="labelStyle" Text="Defecto" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <ajaxToolkit:ComboBox ID="ddlDefecto" runat="server" AutoPostBack="True" DropDownStyle="DropDownList"
                        ...
                        <br />
                        <br />
                        <asp:Label runat="server" CssClass="labelStyle" Text="*" ID="lblObligatorio4" ForeColor="Red" />
                        <asp:Label ID="Label19" runat="server" CssClass="labelStyle" Text="Referencia" />
                        &nbsp; &nbsp;&nbsp;
                        <asp:TextBox ID="txtReferencia" CssClass="css-input" AutoCompleteType="Disabled" runat="server" MaxLength="20"></asp:TextBox>
                        <br />
                        <br />
                        &nbsp;
                        ...
                        <br />
                        <br />
                        <asp:Button ID="btnAgregarDefecto" runat="server" Text="Agregar" Width="138px" OnClick="btnAgregarDefecto_Click" class="blueButton" />
                        <br />
                        <br />
                        <asp:GridView ID="gvDefectos2" runat="server" Style="font-family: Calibri" AutoGenerateSelectButton="True" OnRowCreated="gvDefectos2_RowCreated" OnSelectedIndexChanged="gvDefectos2_SelectedIndexChanged" OnRowDataBound="gvDefectos2_RowDataBound">
                        </asp:GridView>
                        <br />
                    ...
                    <br />
                    &nbsp;&nbsp;&nbsp;
        <asp:Button ID="btnCalidad" CssClass="orangeButton" runat="server" Text="Enviar a CALIDAD" Height="45" Width="182px" OnClick="btnCalidad_Click" />
                    &nbsp;&nbsp;&nbsp
                    <asp:Button ID="btnScrap" CssClass="redButton" runat="server" Text="Enviar a SCRAP" Height="45" Width="182px" BackColor="#FF6666" OnClick="btnScrap_Click" />
                    <br />
                    <br />
                    <br />
                ...
                <asp:UpdatePanel ID="panelGrid" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:GridView ID="gvAnalisis" runat="server" AutoGenerateSelectButton="True" AutoGenerateColumns="false"
                            ...
                            ForeColor="Black" OnSelectedIndexChanged="gvAnalisis_SelectedIndexChanged" Width="100%" OnRowCreated="gvAnalisis_RowCreated" OnRowDataBound="gvAnalisis_RowDataBound">
