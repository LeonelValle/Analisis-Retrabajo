    ...
    <form id="form2" runat="server">
        ...
        <div class="left">
            <div style="text-align: left; margin: 8px">
                ...
                <asp:Label Style="font-family: Calibri; position: absolute; top: 10px; left: 43%;" runat="server" Text="Analisis" Font-Size="XX-Large" Font-Bold="true"></asp:Label>
                <br />
            ...
            <asp:UpdatePanel ID="PanelInfoUnidad" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    &nbsp;&nbsp;
                    <asp:Button ID="btnNuevo" CssClass="greenButton" runat="server" Height="42px" Text="Analisis rapido" Width="150px" OnClick="btnNuevo_Click" />
                    <fieldset>
   ...
   <ajaxToolkit:ComboBox ID="ddlArea" runat="server" AutoPostBack="True" DropDownStyle="DropDownList"
       AutoCompleteMode="Append">
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="btnRWK" EventName="Click" />
            ...
            <asp:UpdatePanel ID="PanelDefectos" runat="server" UpdateMode="Conditional">
                ...
                <ContentTemplate>
                    <fieldset>
                        ...
                        <br />
                        <br />
                        <asp:Label ID="Label14" CssClass="labelStyle" runat="server" Text="*" ForeColor="Red"></asp:Label>
          ...
          <ajaxToolkit:ComboBox ID="ddlDefecto" runat="server" AutoPostBack="True" DropDownStyle="DropDownList"
              AutoCompleteMode="Append">
                        ...
                        <br />
                        <br />
                        <asp:Label ID="Label15" CssClass="labelStyle" runat="server" Text="*" ForeColor="Red"></asp:Label>
                        <asp:Label runat="server" CssClass="labelStyle" Text="Referencia" />
                        &nbsp; &nbsp;&nbsp;
                    ...
                    <asp:TextBox ID="txtpartnumber" runat="server" AutoCompleteType="Disabled" CssClass="css-input" MaxLength="20"></asp:TextBox>
                        ...
                        <asp:GridView ID="gvDefectos" runat="server" AutoGenerateSelectButton="True" Style="font-family: Calibri"
                            OnSelectedIndexChanged="gvDefectos_SelectedIndexChanged" OnRowCreated="gvDefectos_RowCreated" OnRowDataBound="gvDefectos_RowDataBound">
                        </asp:GridView>
                        <br />
                    </fieldset>
                    ...
                    <br />
                    <br />
                    <asp:Button ID="btnRWK" CssClass="greenButton" runat="server" Text="Enviar a RWK" Height="45px" Width="182px" OnClick="btnRWK_Click" />
                    &nbsp;&nbsp;&nbsp;
