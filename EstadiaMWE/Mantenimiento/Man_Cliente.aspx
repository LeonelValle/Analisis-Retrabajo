<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Man_Cliente.aspx.cs" Inherits="EstadiaMWE.Mantenimiento.Man_Cliente" %>
...
<body style="text-align: center">
    <div style="text-align: left">
        ...
        <asp:Label Style="font-family: Calibri; position: absolute; top: 10px; left: 47%;" runat="server" Text="Clientes" Font-Size="XX-Large" Font-Bold="true"></asp:Label>
        <br />
    ...
    <form id="form1" runat="server">
       ...
       <%-- <asp:UpdatePanel ID="UpdatePanelGeneral" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <br />
                    <asp:Label ID="Label2" CssClass="labelStyle" runat="server" Text="Cliente"></asp:Label>
                    &nbsp; &nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="txtCliente" runat="server" AutoCompleteType="Disabled" CssClass="css-input" MaxLength="30"></asp:TextBox>
                    <br />
                ...
                <fieldset>--%>
                    ...
                    &nbsp;<asp:Label ID="Label4" runat="server" CssClass="labelStyle" Text="Cliente"></asp:Label>
                    &nbsp;
                        <asp:TextBox ID="txtBuscarCliente" runat="server" AutoCompleteType="Disabled" CssClass="css-input" MaxLength="30"></asp:TextBox>
                    &nbsp;
