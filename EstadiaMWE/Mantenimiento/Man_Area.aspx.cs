...
{
    public partial class Man_Area : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    //LlenarGrid(Conexion.ConsultaGeneral("CAT_AREA"));
        ...
        protected void btnAlta_Click(object sender, EventArgs e)
        {
            if (camposValidos())
            {
                if (!Conexion.Existe("select count(*) from CAT_AREA where Area = '" + txtArea.Text.Trim() + "'"))
                {
                    Conexion.Alta_Area(new Modelos.ModeloArea { Area = txtArea.Text });
        ...
        protected void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            {
                Conexion.Modificar_Area(new Modelos.ModeloArea { Id_Area = Convert.ToInt32(gvConsulta.SelectedRow.Cells[1].Text), Area = txtArea.Text });
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            gvConsulta.SelectedIndex = -1;
            esModificacion();
            if (txtBuscarArea.Text != "")
            {
                LlenarGrid(Conexion.ConsultaGeneral("CAT_AREA", "Area", "'" + txtBuscarArea.Text + "'"));
            }
        }
        ...
        {
            LimpiarInfoUnidad();
            txtArea.Text = HttpUtility.HtmlDecode(gvConsulta.SelectedRow.Cells[2].Text);
