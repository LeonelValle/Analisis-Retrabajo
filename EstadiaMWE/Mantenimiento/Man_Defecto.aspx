<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Man_Defecto.aspx.cs" Inherits="EstadiaMWE.Mantenimiento.Man_Defecto" %>
...
<head runat="server">
    <title>Mantenimiento de Defectos</title>
...
<body style="text-align: center">
    <div style="text-align: left">
        ...
        <asp:Label Style="font-family: Calibri; position: absolute; top: 10px; left: 47%;" runat="server" Text="Defectos" Font-Size="XX-Large" Font-Bold="true"></asp:Label>
        <br />
    ...
    <form id="form1" runat="server">
        ...
        <legend class="labelStyle">Alta y modificaciones</legend>&nbsp;
                <br />
        <asp:Label ID="Label2" CssClass="labelStyle" runat="server" Text="Codigo"></asp:Label>
        &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="txtCodigo" runat="server" AutoCompleteType="Disabled" CssClass="css-input" MaxLength="16"></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="Label1" CssClass="labelStyle" runat="server" Text="Descripcion"></asp:Label>
        &nbsp; &nbsp;&nbsp;
                <asp:TextBox ID="txtDesc" runat="server" AutoCompleteType="Disabled" CssClass="css-input" MaxLength="30" Height="29px"></asp:TextBox>
        <br />
        <br />
        ...
        &nbsp;<asp:Label ID="Label4" runat="server" CssClass="labelStyle" Text="Codigo"></asp:Label>
        &nbsp;
                        <asp:TextBox ID="txtBuscarCodigo" runat="server" AutoCompleteType="Disabled" CssClass="css-input" MaxLength="16"></asp:TextBox>
        &nbsp;
